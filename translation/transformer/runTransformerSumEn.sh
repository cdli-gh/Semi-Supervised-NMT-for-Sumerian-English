...
onmt_preprocess -train_src $datadir/train.$src -train_tgt $datadir/train.$tgt -valid_src $datadir/dev.$src -valid_tgt $datadir/dev.$tgt -save_data ./data/$langPair/pped
